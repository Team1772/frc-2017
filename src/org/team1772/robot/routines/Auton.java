...
import org.team1772.robot.autons.general.Stop;
import org.team1772.robot.autons.general.Test;
import org.team1772.robot.autons.oldAutons.*;
...
public enum Auton {
	...
	public void init() {
		...
		autons.add(new CenterGear());//              0 GEAR NO CENTRO BOMBANDO
		...
		autons.add(new Stop());//                    7

        SmartDashboard.putNumber("Auto mode", SmartDashboard.getNumber("Auto mode", 0));
        
        SmartDashboard.putNumber("Go to loadstation", SmartDashboard.getNumber("Go to loadstation", 0));
	}
